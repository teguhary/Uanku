        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                <h1 class="h3 mb-0 font-weight-bold text-gray-800">Detail Pengeluaran <?= $bulan ?> <?= $tahun ?></h1>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow mb-4 mt-4">
                                ...
                                <div class="card-body overflow-auto" style="max-height: 440px;">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            <?php foreach ($dtlpengeluaran as $p) : ?>
                                                <tr>
                                                    <th scope="row"><?= $i ?></th>
                                                    ...
                                                    <td><?= $p['tanggal'] ?></td>
                                                    <td>
                                                        <a href="<?= base_url('crudpengeluaran/index/') ?><?= $p['id'] ?>" class="badge badge-pill badge-warning">Edit</a>
                                                        <a href="" class="badge badge-pill badge-danger" data-toggle="modal" onclick="confirm_modal('<?= base_url('crudpengeluaran/hapus/') ?><?= $p['id'] ?>','title');" data-target="modal_delete_m_n">Hapus</a>
                                                    </td>
                                                </tr>
                                                <?php $i++; ?>
                                            <?php endforeach ?>
                        ...
                        <div class="col">
                            <div class="card shadow mb-4 mt-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header">
                                    <p class="m-0 font-weight-bold text-gray-800">Pengeluaran</p>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <p><?= $pesan ?></p>
