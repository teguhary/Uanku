<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
        <h1 class="h3 mb-0 font-weight-bold text-gray-800">Edit Catatan Pengeluaran</h1>
            ...
            <div class="col-md-9">
                ...
                <form class="user" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputAddress" name="nominal" value="<?= $transaksi['nominal'] ?>">
                        <?= form_error('nominal', '<small class="text-danger pl-3">', '</small>') ?>
                    </div>
                    <div class=" form-group">
                        <label for="inputAddress">Keterangan</label>
                        <input type="text" class="form-control" id="inputAddress" name="keterangan" value="<?= $transaksi['keterangan'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="inputAddress" name="tanggal" value="<?= $transaksi['tanggal'] ?>">
                        <?= form_error('keterangan', '<small class="text-danger pl-3">', '</small>') ?>
                    </div>
